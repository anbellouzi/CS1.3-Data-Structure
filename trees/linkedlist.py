...
class LinkedList(object):
    ...
    def get_at_index(self, index, get_node = False):
    ...
    def find(self, quality, get_node=False):
    ...
    def replace(self, old_item, new_item):
        ...
        node = self.find(quality, get_node = True)

        if node:
            node.data = new_item
        else:
            raise ValueError("old item {} not found in linkedlist: {}".format(old_item, self))
