...
class BinarySearchTree(object):
    ...
    def _find_parent_node_recursive(self, item, node, parent=None):
        ...
        # TODO: Check if the given item is greater than the node's data
            ...
            if node.right is not None:
                # print("_________________ parent is right")
    ...
    def delete(self, item):
        ...
        if self._find_node_recursive(item, self.root) is not None:
            pass
    ...
    def items_in_order(self):
        ...
        if not self.is_empty():
            ...
            self._traverse_in_order_recursive(items.append, self.root)
        # Return in-order list of all items in tree
        return items

    def _traverse_in_order_recursive(self, visit, node):
        ...
        if node.right is not None:
            self._traverse_in_order_recursive(visit, node.right)
